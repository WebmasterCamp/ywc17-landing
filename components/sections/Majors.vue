        ...
        <template slot-scope="scope">
          ...
          >
            <template v-slot:content>        
              ...
              <h3>ตัวอย่างคำถาม</h3>
              <ol>
                <li>จงบอก จุดแข็ง (อย่างน้อย 2 ข้อ) และ จุดอ่อน (อย่างน้อย 2 ข้อ) ของสื่อประเภทเว็บไซต์ สำหรับตัวเรา แบรนด์ และธุรกิจ เมื่อเทียบกับสื่อดิจิทัล ประเภทอื่นๆ เช่น โมบายแอปพลิเคชันและโซเชียลมีเดีย เป็นต้น</li>
